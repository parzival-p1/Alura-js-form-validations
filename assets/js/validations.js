...
const mensajesDeError = {
    ...
    password: {
        ...
        patternMismatch: "Al menos 6 caracteres, máximo 12, debe contener una letra minúsucla, una mayúscula, un número y no puede contener caracteres especiales."
    },
    nacimiento: {
...
function mostrarMensajeError(tipoDeInput, input) {
    let mensaje = '';
    tipoDeErrores.forEach( error => { // recorre el arr tipoDeErrores
...
function validarNacimiento(input){
    ...
    //? fills dinamically personalized input msg
    let mensaje = '';
    if(!mayorDeEdad(fechaCliente)) {
        mensaje = "Debes tener al menos 18 años de edad"
    }
    input.setCustomValidity(mensaje); //custom validation
}

//* Verifies if user is +18
